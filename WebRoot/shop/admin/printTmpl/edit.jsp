...
<form method="post" action="printTmpl!saveEdit.do" class="validate"
	...
	<div style="height:67px;width:1000px;border:1px solid #ff0000;">
		<div class="title">
			...
			<input type="text" name="printTmpl.prt_tmpl_title" value="${printTmpl.prt_tmpl_title }"/><br/>
		...
		<div class="title">
			单据尺寸<br/>
			宽<input type="text" style="width:30px;" name="printTmpl.prt_tmpl_width" value="${printTmpl.prt_tmpl_width }" onchange="resizeDesign('width',this)"/>*高<input type="text" style="width:30px;" name="printTmpl.prt_tmpl_height" value="${printTmpl.prt_tmpl_height }" onchange="resizeDesign('height',this)"/>mm
		</div>
		<div class="title">
