...
<c:if test="${isEdit}" >
<form method="post" action="groupBuy!saveEdit.do" class="validate" id="brandForm" onsubmit="return checkgoods();" enctype="multipart/form-data">
<input type="hidden" name="groupBuy.groupid" value="${groupBuy.groupid }" />
</c:if>
<c:if test="${!isEdit}" >
<form method="post" action="groupBuy!saveAdd.do" class="validate" id="brandForm" onsubmit="return checkgoods();" enctype="multipart/form-data">
</c:if>
