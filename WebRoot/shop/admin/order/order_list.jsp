...
<grid:grid  from="webpage">
  ...
  <grid:body item="order">
        ...
        <grid:cell>
        	<button title="购物清单打印" class="p_prted" id="orderprntBtn" onclick="window.open('../shop/admin/orderPrint!order_prnt.do?orderId=${order.order_id }'); return false;" >购</button>
        	<button title="配货单打印" class="p_prted" id="deliveryprntBtn" onclick="window.open('../shop/admin/orderPrint!delivery_prnt.do?orderId=${order.order_id }');return false;" >配</button>
        	<button title="联合打印" class="p_prted" id="globalprntBtn" onclick="window.open('../shop/admin/orderPrint!global_prnt.do?orderId=${order.order_id }');return false;" >合</button>
        	<button title="快递单打印" class="p_prted" id="shipprntBtn" onclick="window.open('../shop/admin/orderPrint!ship_prnt_step1.do?orderId=${order.order_id }');return false;" >递</button>
        </grid:cell> 
  </grid:body>  
