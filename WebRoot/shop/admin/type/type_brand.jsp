...
<div class="main-div">
 <form method="post" action="type!saveBrand.do" name="theForm1" id="theForm1" onsubmit="return selectChoose();">
   <table cellspacing="1" cellpadding="3" width="100%"  class="form-table">
     <tr>
	   ...
	   <input name="submit" type="button" class="button" value="  ->  "  onclick="rightMove();"/>
	   <br/>
	   <input name="submit" type="button" class="button" value="  <-  "  onclick="leftMove();"/>
	   <br/>
	   <input name="submit" type="button" class="button" value="  重置  " onclick="clean();"/>
	   </td>
