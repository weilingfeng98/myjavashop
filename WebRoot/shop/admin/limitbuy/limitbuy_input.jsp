...
<c:if test="${isEdit}" >
<form method="post" action="limitBuy!saveEdit.do" class="validate" onsubmit="return checkgoods();" enctype="multipart/form-data">
<input type="hidden" name="limitBuy.id" value="${limitBuy.id }" />
</c:if>
<c:if test="${!isEdit}" >
<form method="post" action="limitBuy!saveAdd.do" class="validate" onsubmit="return checkgoods();" enctype="multipart/form-data">
</c:if>
